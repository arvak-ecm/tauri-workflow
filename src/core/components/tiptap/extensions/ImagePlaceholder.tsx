    ...
    <NodeViewWrapper className='w-full'>
      <Popover modal open={open}>
        ...
        >
          <div
            className={cn(
              'bg-accent text-accent-foreground hover:bg-secondary flex cursor-pointer items-center gap-3 rounded-sm p-2 py-3 text-sm transition-colors',
          ...
          <Tabs defaultValue='upload' className='px-3'>
            ...
            <TabsContent value='upload'>
              <div
                ...
                onDrop={handleDrop}
                className={cn(
                  'my-2 rounded-sm border border-dashed text-sm transition-colors',
