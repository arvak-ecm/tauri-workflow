...
export const DEFAULT_FONT_SANS =
  '"Inter", "Roboto", "Open Sans", "Poppins", "Montserrat", "Outfit", "Plus Jakarta Sans", "DM Sans", "Nunito"'
...
export const DEFAULT_FONT_MONO =
  '"JetBrains Mono", "Fira Code", "Source Code Pro", "IBM Plex Mono", "Roboto Mono", "Space Mono"'

// Default light theme styles
export const defaultLightThemeStyles: ThemeStyles['light'] = {
  'font-default': 'font-mono',
